...
namespace MusicTracker.Dialogs
{
    ...
    public sealed class GenerateThemeDialog : Window
    {
        static readonly string[] TechLabels =
            { Loc.T("SerielleDodecaphonique"), Loc.T("AutomateCellulaire"), Loc.T("LSysteme"), Loc.T("Genetique"), Loc.T("Fractale1F"), "Thue-Morse" };
        ...
        static readonly string[] RegisterLabels = { Loc.T("Grave"), Loc.T("Medium2"), Loc.T("Aigu") };
        ...
        public GenerateThemeDialog(bool allowPropagate)
        {
            ...
            chkPropagate.Content = Loc.T("PropagerAuxSectionsDeriveesReExpo");
            ...
            cboVarMethod.Items.Add(Loc.T("AutoLAlgoChoisit"));
            ...
            root.Children.Add(new TextBlock { Text = Loc.T("GenererUnThemeProcedural"), Foreground = Res("CommonForeground"), FontSize = 16, FontWeight = FontWeights.Bold, Margin = new Thickness(0, 0, 0, 4) });
            root.Children.Add(new TextBlock { Text = Loc.T("MusiqueSerielleAlgorithmiqueAucunModeleA"), Foreground = new SolidColorBrush(Color.FromRgb(0x88, 0x88, 0x88)), FontSize = 11, TextWrapping = TextWrapping.Wrap, Margin = new Thickness(0, 0, 0, 12), MaxWidth = 380 });

            root.Children.Add(Label(Loc.T("Technique")));
            root.Children.Add(cboTech);
            var row = new StackPanel { Orientation = Orientation.Horizontal, Margin = new Thickness(0, 10, 0, 0) };
            var barsCol = new StackPanel(); barsCol.Children.Add(Label(Loc.T("Mesures"))); barsCol.Children.Add(txtBars);
            var regCol = new StackPanel { Margin = new Thickness(20, 0, 0, 0) }; regCol.Children.Add(Label(Loc.T("Registre"))); cboRegister.Width = 120; cboRegister.HorizontalAlignment = HorizontalAlignment.Left; regCol.Children.Add(cboRegister);
            row.Children.Add(barsCol); row.Children.Add(regCol);
            root.Children.Add(row);

            root.Children.Add(chkPropagate);
            root.Children.Add(Label(Loc.T("MethodeDeVariationPourLaPropagation")));
