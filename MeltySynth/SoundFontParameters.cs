...
namespace MeltySynth
{
    internal sealed class SoundFontParameters
    {
        ...
        internal SoundFontParameters(BinaryReader reader)
        {
            ...
            Modulator[] presetModulators = Array.Empty<Modulator>();
            InstrumentInfo[]? instrumentInfos = null;
            ZoneInfo[]? instrumentBag = null;
            Generator[]? instrumentGenerators = null;
            Modulator[] instrumentModulators = Array.Empty<Modulator>();
            ...
            while (reader.BaseStream.Position < end)
            {
                ...
                switch (id)
                {
                    ...
                    case "pbag":
                        ...
                        break;
                    case "pmod":
                        presetModulators = Modulator.ReadFromChunk(reader, size);
                        break;
                    case "pgen":
                    ...
                    case "ibag":
                        ...
                        break;
                    case "imod":
                        instrumentModulators = Modulator.ReadFromChunk(reader, size);
                        break;
                    case "igen":
